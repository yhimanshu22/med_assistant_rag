...
This project is a powerful Retrieval-Augmented Generation (RAG) system wrapped into a highly scalable FastAPI application with an interactive React UI. It is designed to assist users in querying and retrieving precise information from medical PDF documents using a Llama-3 based natural language processing pipeline.
